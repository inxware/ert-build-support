...
| Referenced by                                                          |
|:-----------------------------------------------------------------------|
| `ert-components/target/envbuildscripts/targetenv_esp32_sdk-packager_paths.sh` |
| `ert-contrib-middleware/inx_build_scripts/source-scripts/inx-xbuilder-source-me-espidf.sh` |
